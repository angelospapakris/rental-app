...
const RoleEnum = z.enum(["TENANT", "OWNER"]);
...
export default function Register() {
  ...
  } = useForm<Form>({ resolver: zodResolver(Schema), defaultValues: { role: "TENANT" } });
  ...
  return (
    <div className="max-w-md mx-auto p-6">
      ...
      <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        {ok && <p className="text-green-700 text-sm">Επιτυχής εγγραφή! Αυτόματη μεταφορά στη σελίδα σύνδεσης…</p>}
